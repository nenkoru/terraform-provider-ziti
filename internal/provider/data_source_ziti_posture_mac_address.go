...
var _ datasource.DataSource = &ZitiPostureMacAddressesDataSource{}

func NewZitiPostureMacAddressesDataSource() datasource.DataSource {
	return &ZitiPostureMacAddressesDataSource{}
}

// ZitiPostureMacAddressesDataSource defines the resource implementation.
type ZitiPostureMacAddressesDataSource struct {
...
func (d *ZitiPostureMacAddressesDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_posture_check_mac_addresses"
}

func (d *ZitiPostureMacAddressesDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *ZitiPostureMacAddressesDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
